...
function About() {
  ...
  return (
    ...
    <div className="content" >
      ...
      <p><strong>Step 1 : </strong> Choose "Create Passport" on the app.</p>
        </div>
        <div className="textbox" data-aos="fade-right">
          <p><strong>Step 2 : </strong> Select your payment plan.</p>
        </div>
        <div className="textbox" data-aos="fade-left">
          <p><strong>Step 3 : </strong> Fill out the payment details.</p>
        </div>
        <div className="textbox" data-aos="fade-right">
          <p><strong>Step 4 : </strong> Fill out your fur baby's details!</p>
        </div>
